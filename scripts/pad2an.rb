...
def get_name(name, chairman = nil)
  ...
  name = name.gsub('委員兼召集人', '').gsub('委員', '').gsub('副召集人', '').gsub('召集人', '').gsub('處長', '').gsub('律師', '').
    ...
    gsub('廳長', '').gsub('主任', '').gsub('社長', '').gsub('秘書長', '').gsub('副執行長', '').gsub('執行長', '').gsub('次長', '').gsub('副總隊長', '').gsub('副局長', '').
    ...
    gsub('司法院', '').gsub('法務部', '').gsub('總統府', '').gsub('副司長', '').gsub('司長', '').gsub('秘書', '').gsub('籌委', '').gsub('助理', '').gsub('司儀', '').gsub('發言', '')
